...
HARGAIN RAFLI FERNAZER,DAN GUA JUGA,KALO MSIH NGAPUS MNDING GAUSH NGE BOOT DECK😏
SUPPORT FAHRIBOTZ
...
//=========== Button ===========//                        
        ...
        const ftroli = { 
            key: { fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fakeimage, surface: 200, message: fake, orderTitle: '™ FahriBotz Ofc ™', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}                                                                        
        const fakecell = (teks) => { 
...
case 'help':
               ...
               listmenuu = [`📝 All Menu`,`📈 Information Menu`,`👨🏻‍💻Group Menu`,`🕹️ Photooxy Menu [Beta Menu]`,`🌐 Textpro Menu [Beta Menu]`,`🖥️ Download Menu`,`👤 Owner Menu`,`💟 Anime Menu`,`💌 Maker Menu`,`🎮 Game Menu`,`📍 Fun Menu`,`🔥 Others Menu`,`🔱 Source Code`]
               nombor = 1
               startnum = 0
...
│ あ ${prefix}nakanomiku
│ あ ${prefix}nakanonino
│ あ ${prefix}nakanoitsuki
│ あ ${prefix}otakudesu
│ あ ${prefix}doujindesu
│ あ ${prefix}otakuongoing
│ あ ${prefix}nhentai
│ あ ${prefix}nekopoi
│ あ ${prefix}nekopoi3d
│ あ ${prefix}nekopoicosplay
│ あ ${prefix}cosplayanime
│ あ ${prefix}nekopoisearch
└⬣`
sendButLocation(from, `${Rafliini}`,
`${footerr}`, {jpegThumbnail: fakeimage}, 
[
...
│ あ ${prefix}ttg
│ あ ${prefix}attp [text]
│ あ ${prefix}ttp [text][New Fitur]
│ あ ${prefix}dadu
│ あ ${prefix}doge
│ あ ${prefix}toimg
│ あ ${prefix}patrick
│ あ ${prefix}garwgura
│ あ ${prefix}stickeranime
│ あ ${prefix}semoji [emoji] 
│ あ ${prefix}sticker
│ あ ${prefix}smeme
│ あ ${prefix}tahta [text][New Fitur]
│ あ ${prefix}ytgold [text][New Fitur]
│ あ ${prefix}ytsilver [text][New Fitur]
│ あ ${prefix}swm
│ あ ${prefix}take
│ あ ${prefix}tovideo
└⬣`
...
│ あ ${prefix}kimiakuis
│ あ ${prefix}caklontong
│ あ ${prefix}tebakjenaka
│ あ ${prefix}tebakanime
│ あ ${prefix}tebaktebakan
│ あ ${prefix}tebakgambar
│ あ ${prefix}tebakbendera
│ あ ${prefix}limitgame
└⬣`
sendButLocation(from, `${Rafliini}`,
`${footerr}`, {jpegThumbnail: fakeimage}, 
...
╭─⬣「 Photooxy Menu」⬣
│ あ ${prefix}captain_as text|text2
│ あ ${prefix}smoke text|text2
│ あ ${prefix}tiktok2 text|text2 
│ あ ${prefix}arcade text|text2
│ あ ${prefix}battlefield text|text2
│ あ ${prefix}pubg text|text2
│ あ ${prefix}shadow text
│ あ ${prefix}cname text
│ あ ${prefix}romantic text
│ あ ${prefix}burnpaper text
│ あ ${prefix}funnycup text
│ あ ${prefix}love text
│ あ ${prefix}undergrass text          
│ あ ${prefix}heart text
│ あ ${prefix}coffeecup text
│ あ ${prefix}wood text          
│ あ ${prefix}flower text         
│ あ ${prefix}wooden text 
│ あ ${prefix}3dsummer text
│ あ ${prefix}wolf_metal text
│ あ ${prefix}3dnature text
│ あ ${prefix}underwater text          
│ あ ${prefix}goldenrose text
│ あ ${prefix}vector text
│ あ ${prefix}typography text
│ あ ${prefix}typography2 text 
│ あ ${prefix}underfall text  
│ あ ${prefix}smokyneon text 
│ あ ${prefix}rainbow text 
│ あ ${prefix}graffiti text
│ あ ${prefix}camouflage text
│ あ ${prefix}3dglowing text          
│ あ ${prefix}vintage text
│ あ ${prefix}honey text 
│ あ ${prefix}whitecube text
│ あ ${prefix}avatar text 
│ あ ${prefix}glowrainbow text
│ あ ${prefix}nightsky text
│ あ ${prefix}fur text
│ あ ${prefix}flaming text          
│ あ ${prefix}crisp text
│ あ ${prefix}embroidery text
│ あ ${prefix}bcake text          
│ あ ${prefix}3dligth text
│ あ ${prefix}metallic text 
│ あ ${prefix}striking text
│ あ ${prefix}watermelon text         
│ あ ${prefix}butterfly text
│ あ ${prefix}harry text
│ あ ${prefix}glowneon text
│ あ ${prefix}coffecup2 text          
│ あ ${prefix}luxury text 
│ あ ${prefix}cemetery text
│ あ ${prefix}woodblock text
│ あ ${prefix}sweet text
│ あ ${prefix}simple text
│ あ ${prefix}bevel text
│ あ ${prefix}underflower text         
│ あ ${prefix}underflower2 text
└⬣`
sendButLocation(from, `${Rafliini}`,
`${footerr}`, {jpegThumbnail: fakeimage}, 
[
...
╭─⬣「 Textpro Menu」⬣
│ あ ${prefix}halloween2 text|text2
│ あ ${prefix}horror text|text2
│ あ ${prefix}game8bit text|text2
│ あ ${prefix}layered text|text2
│ あ ${prefix}glitch2 text|text2
│ あ ${prefix}coolg text|text2
│ あ ${prefix}coolwg text|text2
│ あ ${prefix}realistic text|text2
│ あ ${prefix}space3d text|text2
│ あ ${prefix}gtiktok text|text2
│ あ ${prefix}stone text|text2
│ あ ${prefix}marvel text|text2
│ あ ${prefix}marvel2 text|text2
│ あ ${prefix}pornhub text|text2
│ あ ${prefix}avengers text|text2
│ あ ${prefix}metalr text|text2
│ あ ${prefix}metalg text|text2
│ あ ${prefix}metalg2 text|text2
│ あ ${prefix}halloween2 text|text2
│ あ ${prefix}lion text|text2
│ あ ${prefix}wolf_bw text|text2
│ あ ${prefix}wolf_g text|text2
│ あ ${prefix}ninja text|text2
│ あ ${prefix}3dsteel text|text2
│ あ ${prefix}horror2 text|text2
│ あ ${prefix}lava text|text2
│ あ ${prefix}bagel text|text2
│ あ ${prefix}blackpink text
│ あ ${prefix}rainbow2 text
│ あ ${prefix}water_pipe text
│ あ ${prefix}halloween text
│ あ ${prefix}sketch text
│ あ ${prefix}sircuit text
│ あ ${prefix}discovery text
│ あ ${prefix}metallic2 text
│ あ ${prefix}fiction text
│ あ ${prefix}demon text
│ あ ${prefix}transformer text
│ あ ${prefix}berry text
│ あ ${prefix}thunder text
│ あ ${prefix}magma text
│ あ ${prefix}3dstone text
│ あ ${prefix}neon text
│ あ ${prefix}glitch text
│ あ ${prefix}harry_potter text
│ あ ${prefix}embossed text
│ あ ${prefix}broken text
│ あ ${prefix}papercut text
│ あ ${prefix}gradient text
│ あ ${prefix}glossy text
│ あ ${prefix}watercolor text
│ あ ${prefix}multicolor text
│ あ ${prefix}neon_devil text
│ あ ${prefix}underwater text
│ あ ${prefix}bear text
│ あ ${prefix}wonderfulg text
│ あ ${prefix}christmas text
│ あ ${prefix}neon_light text
│ あ ${prefix}snow text
│ あ ${prefix}cloudsky text
│ あ ${prefix}luxury2 text
│ あ ${prefix}gradient2 text
│ あ ${prefix}summer text
│ あ ${prefix}writing text
│ あ ${prefix}engraved text
│ あ ${prefix}summery text
│ あ ${prefix}3dglue text
│ あ ${prefix}metaldark text
│ あ ${prefix}neonlight text
│ あ ${prefix}oscar text
│ あ ${prefix}minion text
│ あ ${prefix}holographic text
│ あ ${prefix}purple text
│ あ ${prefix}glossyb text
│ あ ${prefix}deluxe2 text
│ あ ${prefix}glossyc text
│ あ ${prefix}fabric text
│ あ ${prefix}neonc text
│ あ ${prefix}newyear text
│ あ ${prefix}newyear2 text
│ あ ${prefix}metals text
│ あ ${prefix}xmas text
│ あ ${prefix}blood text
│ あ ${prefix}darkg text
│ あ ${prefix}joker text
│ あ ${prefix}wicker text
│ あ ${prefix}natural text
│ あ ${prefix}firework text
│ あ ${prefix}skeleton text
│ あ ${prefix}balloon text
│ あ ${prefix}balloon2 text
│ あ ${prefix}balloon3 text
│ あ ${prefix}balloon4 text
│ あ ${prefix}balloon5 text
│ あ ${prefix}balloon6 text
│ あ ${prefix}balloon7 text
│ あ ${prefix}steel text
│ あ ${prefix}gloss text
│ あ ${prefix}denim text
│ あ ${prefix}decorate text
│ あ ${prefix}decorate2 text
│ あ ${prefix}peridot text
│ あ ${prefix}rock text
│ あ ${prefix}glass text
│ あ ${prefix}glass2 text
│ あ ${prefix}glass3 text
│ あ ${prefix}glass4 text
│ あ ${prefix}glass5 text
│ あ ${prefix}glass6 text
│ あ ${prefix}glass7 text
│ あ ${prefix}glass8 text
│ あ ${prefix}captain_as2 text
│ あ ${prefix}robot text
│ あ ${prefix}equalizer text
│ あ ${prefix}toxic text
│ あ ${prefix}sparkling text
│ あ ${prefix}sparkling2 text
│ あ ${prefix}sparkling3 text
│ あ ${prefix}sparkling4 text
│ あ ${prefix}sparkling5 text
│ あ ${prefix}sparkling6 text
│ あ ${prefix}sparkling7 text
│ あ ${prefix}decorative text
│ あ ${prefix}chocolate text
│ あ ${prefix}strawberry text
│ あ ${prefix}koifish text
│ あ ${prefix}bread text
│ あ ${prefix}matrix text
│ あ ${prefix}blood2 text
│ あ ${prefix}neonligth2 text
│ あ ${prefix}thunder2 text
│ あ ${prefix}3dbox text
│ あ ${prefix}neon2 text
│ あ ${prefix}roadw text
│ あ ${prefix}bokeh text
│ あ ${prefix}gneon text
│ あ ${prefix}advanced text
│ あ ${prefix}dropwater text
│ あ ${prefix}wall text
│ あ ${prefix}chrismast text
│ あ ${prefix}honey text
│ あ ${prefix}drug text
│ あ ${prefix}marble text
│ あ ${prefix}marble2 text
│ あ ${prefix}ice text
│ あ ${prefix}juice text
│ あ ${prefix}rusty text
│ あ ${prefix}abstra text
│ あ ${prefix}biscuit text
│ あ ${prefix}wood text
│ あ ${prefix}scifi text
│ あ ${prefix}metalr text
│ あ ${prefix}purpleg text
│ あ ${prefix}shiny text 
│ あ ${prefix}jewelry text
│ あ ${prefix}jewelry2 text
│ あ ${prefix}jewelry3 text
│ あ ${prefix}jewelry4 text
│ あ ${prefix}jewelry5 text
│ あ ${prefix}jewelry6 text
│ あ ${prefix}jewelry7 text
│ あ ${prefix}jewelry8 text
│ あ ${prefix}metalh text
│ あ ${prefix}golden text
│ あ ${prefix}glitter text
│ あ ${prefix}glitter2 text
│ あ ${prefix}glitter3 text
│ あ ${prefix}glitter4 text
│ あ ${prefix}glitter5 text
│ あ ${prefix}glitter6 text
│ あ ${prefix}glitter7 text
│ あ ${prefix}metale text
│ あ ${prefix}carbon text
│ あ ${prefix}candy text
│ あ ${prefix}metalb text
│ あ ${prefix}gemb text
│ あ ${prefix}3dchrome text
│ あ ${prefix}metalb2 text
│ あ ${prefix}metalg text
│ あ ${prefix}metalg text
└⬣`
sendButLocation(from, `${Rafliini}`,
`${footerr}`, {jpegThumbnail: fakeimage}, 
...
sendButImage(from,  `Nih udah jadi kak, jgn lupa donasi 🐦 ` , `${setting.botName}™© | By ${setting.ownerName}`,photooxy, [{"buttonId": `owner`,"buttonText": {"displayText": "👨‍💻 Owner"},"type": "RESPONSE"},{"buttonId": `donasi`,"buttonText": {"displayText": "💰 Donate"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break                                         
...
sendButImage(from,  `Nih udah jadi kak, jgn lupa donasi 🐦 ` , `${setting.botName}™© | By ${setting.ownerName}`,photooxy2, [{"buttonId": `owner`,"buttonText": {"displayText": "👨‍💻 Owner"},"type": "RESPONSE"},{"buttonId": `donasi`,"buttonText": {"displayText": "💰 Donate"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break         
...
sendButImage(from,  `Nih udah jadi kak, jgn lupa donasi 🐦 ` , `${setting.botName}™© | By ${setting.ownerName}`,textpro, [{"buttonId": `owner`,"buttonText": {"displayText": "👨‍💻 Owner"},"type": "RESPONSE"},{"buttonId": `donasi`,"buttonText": {"displayText": "💰 Donate"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break 
...
sendButImage(from,  `Nih udah jadi kak, jgn lupa donasi 🐦 ` , `${setting.botName}™© | By ${setting.ownerName}`,textpro2, [{"buttonId": `owner`,"buttonText": {"displayText": "👨‍💻 Owner"},"type": "RESPONSE"},{"buttonId": `donasi`,"buttonText": {"displayText": "💰 Donate"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break  
//=========== Game ===========//
        case 'limitgame': 
...
client.sendMessage(from, Rafliyah, MessageType.audio, {quoted: ftroli, mimetype: 'audio/mp4', ptt:true})
      ...
      case 'sc':
      case 'sourcecode':
              textImg(`╭─⬣「 SC ORI 」⬣\n│https://youtube.com/Fernazer\n└⬣ Fernazer\n╭─⬣「 RECODE 」⬣\n│ MediaFire : https://bit.ly/3ubXoop\n│ Github : https://bit.ly/3HcXcco\n└⬣ FahriOfc`)
